...
Processing(1).Frames.End = 1999;
Processing(1).Frames.Step = 2;
...
% Poiseuille diffusion 1.50 ensemble APC
n = n + 1;
JOBLIST(n) = JobFile;
...
% Poiseuille diffusion 1.50 instantaneous APC
n = n + 1;
JOBLIST(n) = JobFile;
...
JOBLIST(n).Processing(1).Correlation.Ensemble.DoEnsemble = false;
JOBLIST(n).Processing(1).Correlation.Ensemble.Type = 'none';
JOBLIST(n).Processing(1).Correlation.SpectralWeighting.Method = 'rpc';
JOBLIST(n).Data.Inputs.Images.BaseName = 'poiseuille_diffusion_1.50_';
JOBLIST(n).Data.Inputs.Images.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_1.50/raw';
JOBLIST(n).Data.Outputs.Vectors.BaseName = 'poiseuille_vect_h128_w128_diff_std_1.50_rpc_';
JOBLIST(n).Data.Outputs.Vectors.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_1.50/vect/instantaneous/rpc';

% Poiseuille diffusion 1.50 instantaneous SCC
n = n + 1;
JOBLIST(n) = JobFile;
JOBLIST(n).Processing(1).Correlation.Ensemble.DoEnsemble = false;
JOBLIST(n).Processing(1).Correlation.Ensemble.Type = 'none';
JOBLIST(n).Processing(1).Correlation.SpectralWeighting.Method = 'scc';
JOBLIST(n).Data.Inputs.Images.BaseName = 'poiseuille_diffusion_1.50_';
JOBLIST(n).Data.Inputs.Images.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_1.50/raw';
JOBLIST(n).Data.Outputs.Vectors.BaseName = 'poiseuille_vect_h128_w128_diff_std_1.50_scc_';
JOBLIST(n).Data.Outputs.Vectors.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_1.50/vect/instantaneous/scc';
...
% Poiseuille diffusion 3.00 ensemble APC
n = n + 1;
JOBLIST(n) = JobFile;
JOBLIST(n).Processing(1).Correlation.SpectralWeighting.Method = 'apc';
...
% Poiseuille diffusion 3.00 instantaneous APC
n = n + 1;
JOBLIST(n) = JobFile;
JOBLIST(n).Processing(1).Correlation.Ensemble.DoEnsemble = false;
JOBLIST(n).Processing(1).Correlation.Ensemble.Type = 'none';
...
JOBLIST(n).Data.Inputs.Images.BaseName = 'poiseuille_diffusion_3.00_';
JOBLIST(n).Data.Inputs.Images.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_3.00/raw';
JOBLIST(n).Data.Outputs.Vectors.BaseName = 'poiseuille_vect_h128_w128_diff_std_3.00_rpc_';
JOBLIST(n).Data.Outputs.Vectors.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_3.00/vect/instantaneous/rpc';

% Poiseuille diffusion 3.00 instantaneous SCC
n = n + 1;
JOBLIST(n) = JobFile;
JOBLIST(n).Processing(1).Correlation.Ensemble.DoEnsemble = false;
JOBLIST(n).Processing(1).Correlation.Ensemble.Type = 'none';
...
JOBLIST(n).Data.Inputs.Images.BaseName = 'poiseuille_diffusion_3.00_';
JOBLIST(n).Data.Inputs.Images.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_3.00/raw';
JOBLIST(n).Data.Outputs.Vectors.BaseName = 'poiseuille_vect_h128_w128_diff_std_3.00_scc_';
JOBLIST(n).Data.Outputs.Vectors.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_3.00/vect/instantaneous/scc';
...
% Poiseuille diffusion 4.50 ensemble APC
n = n + 1;
JOBLIST(n) = JobFile;
JOBLIST(n).Processing(1).Correlation.SpectralWeighting.Method = 'apc';
...
% Poiseuille diffusion 4.50 instantaneous APC
n = n + 1;
JOBLIST(n) = JobFile;
JOBLIST(n).Processing(1).Correlation.Ensemble.DoEnsemble = false;
JOBLIST(n).Processing(1).Correlation.Ensemble.Type = 'none';
...
JOBLIST(n).Data.Inputs.Images.BaseName = 'poiseuille_diffusion_4.50_';
JOBLIST(n).Data.Inputs.Images.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_4.50/raw';
JOBLIST(n).Data.Outputs.Vectors.BaseName = 'poiseuille_vect_h128_w128_diff_std_4.50_rpc_';
JOBLIST(n).Data.Outputs.Vectors.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_4.50/vect/instantaneous/rpc';

% Poiseuille diffusion 4.50 instantaneous SCC
n = n + 1;
JOBLIST(n) = JobFile;
JOBLIST(n).Processing(1).Correlation.Ensemble.DoEnsemble = false;
JOBLIST(n).Processing(1).Correlation.Ensemble.Type = 'none';
...
JOBLIST(n).Data.Inputs.Images.BaseName = 'poiseuille_diffusion_4.50_';
JOBLIST(n).Data.Inputs.Images.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_4.50/raw';
JOBLIST(n).Data.Outputs.Vectors.BaseName = 'poiseuille_vect_h128_w128_diff_std_4.50_scc_';
JOBLIST(n).Data.Outputs.Vectors.Directory = '/home/shannon/b/aether/piv_test_images/poiseuille_diffusion_4.50/vect/instantaneous/scc';
